...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.order_place = QtWidgets.QAction(MainWindow)
        self.order_place.setObjectName("order_place")
        self.fin_res_by_order = QtWidgets.QAction(MainWindow)
        self.fin_res_by_order.setObjectName("fin_res_by_order")
        self.add_size = QtWidgets.QAction(MainWindow)
        self.add_size.setObjectName("add_size")
        self.size_by_cloth = QtWidgets.QAction(MainWindow)
        self.size_by_cloth.setObjectName("size_by_cloth")
        self.add_sell_pl = QtWidgets.QAction(MainWindow)
        self.add_sell_pl.setObjectName("add_sell_pl")
        self.action_5 = QtWidgets.QAction(MainWindow)
        self.action_5.setObjectName("action_5")
        self.save_table = QtWidgets.QAction(MainWindow)
        ...
        self.menu_3.addAction(self.size_by_cloth)
        ...
        self.menu.addAction(self.order_place)
        self.menu.addAction(self.fin_res_by_order)
        ...
        self.menu_7.addAction(self.save_table)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_7.setTitle(_translate("MainWindow", "Таблица"))
        ...
        self.fin_result.setText(_translate("MainWindow", "Фин результат общий"))
        ...
        self.order_place.setText(_translate("MainWindow", "Места заказа"))
        self.fin_res_by_order.setText(_translate("MainWindow", "Фин результат по заказам"))
        self.add_size.setText(_translate("MainWindow", "Размер"))
        self.size_by_cloth.setText(_translate("MainWindow", "Размеры по товару"))
        self.add_sell_pl.setText(_translate("MainWindow", "Место продажи"))
        self.action_5.setText(_translate("MainWindow", "Размеры по всем товарам"))
        self.save_table.setText(_translate("MainWindow", "Экспорт таблицы в Excel"))
